...
def get_ai_response(user_input):
    try:
        ...
        messages=[
            {"role": "system", "content": "Ты будешь меня хвалить. Я девушка. Называй меня Мариша, Маришенька, Мариночка, Солнышко, Солнце, Маришечка"},  # Системное сообщение для настройки поведения
